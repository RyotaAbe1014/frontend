...
export function SprintBacklogEditModal(props: Props): JSX.Element {
      ...
      <BaseModal showModal={isOpen} setShowModal={setIsOpen}>
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-2">
              <select className="block w-full px-4 py-2 border rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500">
